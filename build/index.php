  ...
  <body>
      ...
      <section class="contact">
        ...
        <form class="contact__form" action="" method="post">
          ...
          <div class="captcha" style="display: flex;justify-content: center;margin: 20px;">
            <div class="g-recaptcha" data-sitekey="6LfSayQaAAAAAOrk34tdRbyKfUN5D4cqOea8KB4o" data-theme="dark"></div>
          </div>
    ...
    <footer class="footer">
        <div class="footer__copyright">
          ...
          <small class="footer__text footer__text--rights" id="copyright">
            ©2021 Artyom Volkov. All rights reserved.
          </small>
        </div>
        <div class="footer__social">
          <a class="footer__item footer__item--mail" href="mailto:admin@artemvolkov.online" target="_blank">
          ...
          <a class="footer__item footer__item--vk" href="https://vk.com/volkov.online" target="_blank">
          ...
          <a class="footer__item footer__item--instagram" href="https://instagram.com/avolkov.online/" target="_blank">
          ...
          <a class="footer__item footer__item--facebook" href="https://www.facebook.com/volkov.online" target="_blank">
