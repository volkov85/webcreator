  ...
  <body>
    ...
    <main class="main">
      ...
      <section class="about">
        ...
        <p class="about__desc">
          <span class="about__desc--colored">Technologies:</span> Gulp, Sass, Less, Git, BEM, Mobile First.
        </p>
      </section>
    ...
    <footer class="footer">
        ...
        <div class="footer__social">
          <a class="footer__item footer__item--mail" href="mailto:admin@webcreator.top">
          ...
          <a class="footer__item footer__item--github" href="https://github.com/volkov85">
          ...
          <a class="footer__item footer__item--instagram" href="https://instagram.com/volkov.creator/">
          ...
          <a class="footer__item footer__item--facebook" href="https://www.facebook.com/volkov.creator">
